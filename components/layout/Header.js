...
export default function Example({ setCart, cartStatus, cart }) {
  ...
  return (
    <div className="text-gray-800 dark:text-gray-200 fixed w-full z-10">
      ...
      <header className="relative bg-gray-50 dark:bg-gray-900">
        <nav
          aria-label="Top"
            ...
            <div className="flex h-16 items-center">
                ...
                <div className="flex h-full space-x-8">
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium dark:hover:text-gray-500 hover:text-gray-500"
                    >
                      {page.name}
                    </a>
                  ))}
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="flex lg:mr-6">
                  <a
                    href="#"
                    className="p-2 text-gray-400 dark:text-gray-200  hover:text-gray-500"
                  >
                ...
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a
                    href="#"
                    className="text-sm font-medium  hover:text-gray-500 dark:hover:text-gray-500"
                  >
                    Sign in
                  </a>
                  <span
